...
def main():
    st.title("TICK_PICK_EDUCATION AI")
    st.subheader("Your Personalized Tutor")

    # Sidebar for app selection
    st.logo("png-transparent-adobe-ai-illustrator-logo-logos-logos-and-brands-icon-thumbnail.png")
